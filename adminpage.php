...
$pesanan = query("SELECT * FROM `pesanan` ORDER BY `id_pesanan` DESC");
...
<?php foreach ($pesanan as $row) : ?>
  <div class="row">
      ...
      <?php echo $row["id_pesanan"];?>
              ...
              <div class="cell" data-title="Nama Desain">
                     <?php echo $row["namadesain"];?>
              </div>
              <div class="cell" data-title="Telepon">
               ...
               <div class="cell" data-title="Email">
                ...
                <?php echo $row["alamat"];?>
                 ...
                 <div class="cell" data-title="Contoh Gambar">
                  <img <?php echo $row["gambar"]; ?> width="80" height="80">
              </div>
              <div class="cell" data-title="Tanggal">
                <?php echo $row["tanggal"];?>
              </div>
                 <div class="cell" data-title="Catatan">
