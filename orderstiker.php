      ...
      <div class="col-md-4">
        <div class="single-sidebar">
          <div class="thubmnail-recent">
            <img src="images/hargastiker.png" class="recent-thumb" alt="harga desain">
            </div>
          </div> 
      </div>
...
<div class="footer-left">
   <a href="index.php"> <img src="images/logoo.png" width="220" height="35" alt="bamslogo" /> </a>
...
<div class="footer-center">
        <div>
          <p class="footer-company-name">Ruang Grafika &copy; 2018. All Right Reservered.</p>
        </div>
