  ...
  <div class="row">
      ...
      <?php echo $row["id_pelanggan"];?>
              ...
              <div class="cell" data-title="password">
               ...
               <div class="cell" data-title="ubah">
<a href="ubah.php?id=<?php echo $row["id_pelanggan"]; ?>">Ubah</a>
                
              </div>
             <div class="cell" data-title="hapus">
    <a href="hapus.php?id=<?php echo $row["id_pelanggan"]; ?>" onclick="return confirm('yakin?');">Hapus</a>
              </div>
