...
<h2><center> Beberapa Testimoni Dari Pelanggan Kami </center> </h2> <br><br>
...
<div class="testimoni">
      ...
      <div class="row text-center text-lg-left">
        ...
        <div class="col-lg-3 col-md-4 col-xs-6">
            <img class="img-fluid img-thumbnail" src="images/testi.jpg" width="200px" height="200px" alt="screenshot testimoni">
        </div>
        <div class="col-lg-3 col-md-4 col-xs-6">
            <img class="img-fluid img-thumbnail" src="images/testi1.png"  width="200px" height="200px"alt="screenshot testimoni">
        </div>
        <div class="col-lg-3 col-md-4 col-xs-6">
            <img class="img-fluid img-thumbnail" src="images/testi2.png" width="200px" height="200px" alt="screenshot testimoni">
        </div>
        <div class="col-lg-3 col-md-4 col-xs-6">
            <img class="img-fluid img-thumbnail" src="images/testi3.jpg" width="200px" height="200px" alt="screenshot testimoni">
        </div>
</div>
</div>
</div>
