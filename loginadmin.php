...
//cek cookie
if (isset($_COOKIE['loginadmin']) && isset($_COOKIE['ganteng']) ) {
  $id = $_COOKIE['bamswijayanto'];
  $key = $_COOKIE['ganteng'];
  
  //ambil username berdasarkan id
  $result = mysqli_query($conn, "SELECT username FROM admin WHERE id_admin = $id_admin");
  ...
  if(mysqli_num_rows($result) === 1 ){
    ...
    $_SESSION["loginadmin"] = true;
     //cek remember me
      ...
      //buat cookie
        setcookie('bamswijayanto', $row['id'], time()+1600);
        setcookie('ganteng', hash('sha256', $row['username']), time()+1600);
      }
        ...
        <form class="login100-form validate-form" method="POST">
          ...
          <div class="wrap-input100 validate-input" data-validate="Enter password">
            ...
            <div class="wrap-login100-form-btn">
              ...
              <button class="login100-form-btn" name="loginadmin">
                Login!
              </button>
